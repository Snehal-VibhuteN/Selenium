...
public class BlinkElementDemo2Assignment {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		highlight(js,txtFirstName, "My Cyber", ticks,true);

	 	WebElement txtLastName = driver.findElement(By.name("lastname"));
		highlight(js,txtLastName, "Success",ticks,false);
		
		
		WebElement txtEmail = driver.findElement(By.name("reg_email__"));
		highlight(js,txtEmail,"CyberSuccess@gmail.com",ticks,false);
	...
	static void highlight(JavascriptExecutor js, WebElement element, String data, int ticks,boolean flag)
