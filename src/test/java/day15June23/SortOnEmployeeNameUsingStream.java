...
public class SortOnEmployeeNameUsingStream {
	...
	public static void main(String [] args) {
		...
		driver.findElement(By.xpath(("(//div[@role='columnheader']/div/i)[3]"))).click();
	     ...
	     List<String> lowString=low.stream().map(s ->s.getText().toLowerCase()).collect(Collectors.toList()); //ascending
	  ...
	  //   System.out.println("-".repeat(40));
	     ...
	     cnt=1;
	     System.out.println("exp acs list");
